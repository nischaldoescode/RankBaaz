/**
 * defines the legal pages database schema, validation rules, indexes, and document relationships
 *
 * @file backend/models/legalpages.js
 * @module backend/models/legalpages
