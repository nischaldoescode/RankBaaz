/**
 * builds the admin contact preview helper view used for content previews and modal workflows
 *
 * @file admin/src/helpers/contactpreview.jsx
 * @module admin/src/helpers/contactpreview
