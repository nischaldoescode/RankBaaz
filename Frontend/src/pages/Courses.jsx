            ...
            <div className="relative aspect-video bg-gray-100 overflow-hidden rounded-t-lg flex-shrink-0">
              ...
              {course.teacher && (
                <div className="absolute bottom-3 left-3">
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-background/90 backdrop-blur-sm rounded-full text-xs font-medium text-foreground border border-border/60">
                    <svg
